...
import dashboard_accounts    # noqa: F401 -- registers login + the auth guard on `app`
...
def _bootstrap():
    ...
    steps += [
        ...
        ("accounts schema (M8)",     module8_accounts.init_accounts_schema),
